...
export default function RegisterPage() {
  ...
  async function submit(event: React.FormEvent<HTMLFormElement>) {
    ...
    if (!response.ok) setError(result.error); else {
