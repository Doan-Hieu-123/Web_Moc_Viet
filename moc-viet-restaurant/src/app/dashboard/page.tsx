...
export default async function DashboardPage() {
  ...
  const user = userId ? getDatabase().prepare("SELECT fullName, email, role FROM User WHERE id = ?").get(userId) as { fullName: string; email: string; role: string } | undefined : undefined;
